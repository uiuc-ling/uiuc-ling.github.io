...
In-class exercises during a lab session must be turned in before **12:00:00 the *first* Friday** after the lab session takes place. A Homework assignment is normally due by **23:59:59 the _second_ Saturday** after it is announced. **Lab exercises and homework assignments turned in late will be docked 15 percentage points per day late**. If an assignment is not submitted by the fourth day after its due date, no points will be given to the assignment.
